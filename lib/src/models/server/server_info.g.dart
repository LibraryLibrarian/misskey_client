...
ServerMemInfo _$ServerMemInfoFromJson(Map<String, dynamic> json) =>
    ServerMemInfo(total: json['total'] as num);

Map<String, dynamic> _$ServerMemInfoToJson(ServerMemInfo instance) =>
    <String, dynamic>{'total': instance.total};

ServerFsInfo _$ServerFsInfoFromJson(Map<String, dynamic> json) =>
    ServerFsInfo(total: json['total'] as num, used: json['used'] as num);

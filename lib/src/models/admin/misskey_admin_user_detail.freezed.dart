...
mixin _$MisskeyAdminUserDetail {
 ...
 String? get email; bool? get emailVerified; String? get followedMessage; bool? get autoAcceptFollowed; bool? get noCrawle; bool? get preventAiLearning; bool? get alwaysMarkNsfw; bool? get autoSensitive; bool? get carefulBot; bool? get injectFeaturedNote; bool? get receiveAnnouncementEmail; List<MutedWord>? get mutedWords; List<String>? get mutedInstances; Map<String, dynamic>? get notificationRecieveConfig; bool? get isModerator; bool? get isSilenced; bool? get isSuspended; bool? get isHibernated; DateTime? get lastActiveDate; String? get moderationNote; List<MisskeySignin>? get signins; MisskeyRolePolicies? get policies; List<MisskeyRole>? get roles; List<MisskeyRoleAssign>? get roleAssigns;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,email,emailVerified,followedMessage,autoAcceptFollowed,noCrawle,preventAiLearning,alwaysMarkNsfw,autoSensitive,carefulBot,injectFeaturedNote,receiveAnnouncementEmail,const DeepCollectionEquality().hash(mutedWords),const DeepCollectionEquality().hash(mutedInstances),const DeepCollectionEquality().hash(notificationRecieveConfig),isModerator,isSilenced,isSuspended,isHibernated,lastActiveDate,moderationNote,const DeepCollectionEquality().hash(signins),policies,const DeepCollectionEquality().hash(roles),const DeepCollectionEquality().hash(roleAssigns)]);
...
as MisskeyRolePolicies?,roles: freezed == roles ? _self.roles : roles // ignore: cast_nullable_to_non_nullable

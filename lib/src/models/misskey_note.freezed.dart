...
mixin _$MisskeyNote {
 ...
 String get id; DateTime get createdAt; String get userId; MisskeyUser get user; String? get text; String? get cw; MisskeyNoteVisibility? get visibility; bool? get localOnly; MisskeyReactionAcceptance? get reactionAcceptance; int? get renoteCount; int? get repliesCount; int? get reactionCount; Map<String, int>? get reactions; Map<String, String>? get emojis; List<String>? get fileIds; List<MisskeyDriveFile>? get files; String? get replyId; String? get renoteId; MisskeyNote? get reply; MisskeyNote? get renote; String? get uri; String? get url; String? get channelId; MisskeyNoteChannel? get channel; List<String>? get mentions; List<String>? get visibleUserIds; List<String>? get tags; MisskeyPoll? get poll; bool? get hasPoll; String? get myReaction; int? get clippedCount; DateTime? get deletedAt; bool? get isHidden; Map<String, String>? get reactionEmojis; List<String>? get reactionAndUserPairCache;
...
@useResult
$Res call({
 String id, DateTime createdAt, String userId, MisskeyUser user, String? text, String? cw, MisskeyNoteVisibility? visibility, bool? localOnly, MisskeyReactionAcceptance? reactionAcceptance, int? renoteCount, int? repliesCount, int? reactionCount, Map<String, int>? reactions, Map<String, String>? emojis, List<String>? fileIds, List<MisskeyDriveFile>? files, String? replyId, String? renoteId, MisskeyNote? reply, MisskeyNote? renote, String? uri, String? url, String? channelId, MisskeyNoteChannel? channel, List<String>? mentions, List<String>? visibleUserIds, List<String>? tags, MisskeyPoll? poll, bool? hasPoll, String? myReaction, int? clippedCount, DateTime? deletedAt, bool? isHidden, Map<String, String>? reactionEmojis, List<String>? reactionAndUserPairCache
});
...
as MisskeyPoll?,hasPoll: freezed == hasPoll ? _self.hasPoll : hasPoll // ignore: cast_nullable_to_non_nullable

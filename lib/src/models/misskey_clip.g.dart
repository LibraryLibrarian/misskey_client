...
MisskeyClip _$MisskeyClipFromJson(Map<String, dynamic> json) => MisskeyClip(
  ...
  lastClippedAt: const SafeDateTimeConverter().fromJson(
    json['lastClippedAt'] as String?,
  ),
  user: json['user'] == null
      ? null
...
Map<String, dynamic> _$MisskeyClipToJson(
  MisskeyClip instance,
) => <String, dynamic>{
  'id': instance.id,
  'createdAt': instance.createdAt.toIso8601String(),
  'lastClippedAt': const SafeDateTimeConverter().toJson(instance.lastClippedAt),

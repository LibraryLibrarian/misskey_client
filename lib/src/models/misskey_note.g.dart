...
MisskeyNote _$MisskeyNoteFromJson(Map<String, dynamic> json) => MisskeyNote(
  ...
  channel: json['channel'] == null
      ? null
      : MisskeyNoteChannel.fromJson(json['channel'] as Map<String, dynamic>),
  ...
  reactionEmojis:
      ...
      {},
  reactionAndUserPairCache: (json['reactionAndUserPairCache'] as List<dynamic>?)
      ?.map((e) => e as String)
      .toList(),
);
